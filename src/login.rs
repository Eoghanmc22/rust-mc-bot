...
//0x02
pub fn process_login_success_packet(buffer : &mut Buf, mut bot : RwLockWriteGuard<BotInfo>) {
...
//0x03
pub fn process_set_compression_packet(buf : &mut Buf, mut bot : RwLockWriteGuard<BotInfo>) {
